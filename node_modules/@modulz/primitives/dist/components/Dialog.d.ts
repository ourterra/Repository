...
export declare type DialogParts = {
    wrapper: '';
    content: 'enter' | 'opened' | 'exit';
    overlay: 'enter' | 'opened' | 'exit';
};
declare type DialogDOMProps = React.ComponentPropsWithRef<'div'>;
declare type DialogStyleConfigProp = {
    styleConfig?: StyleConfig<DialogParts>;
};
declare type DialogSystemProps = BoxSystemProps;
