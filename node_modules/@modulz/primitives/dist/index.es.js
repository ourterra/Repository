...
import { spaceSet, sx } from '@modulz/radix-system';
import merge from 'lodash.merge';
import pick from 'lodash.pick';
import { AvatarIcon, CheckIcon } from '@modulz/radix-icons';
...
var boxSystemPropNames = __spreadArrays((spaceSet.propNames || []), ['sx']);
...
var Avatar = React.forwardRef(function Avatar(props, forwardedRef) {
    ...
    if (hasWorkingImage) {
        ...
        children = React.createElement(AvatarIcon, null);
    }
    ...
    return (React.createElement(Wrapper, __assign({ className: className, style: style }, systemProps),
        ...
        React.createElement(CheckboxPart, { checkboxStyles: checkboxStyles },
            React.createElement(IconPart, { iconStyles: iconStyles },
                React.createElement(CheckIcon, { style: { display: 'block' } })))));
});
...
function PresenceTransition(_a) {
    ...
    return (React.createElement(Transition, { in: isPresent, timeout: MAX_TIMEOUT_BEFORE_FORCED_UNMOUNT, mountOnEnter: true, unmountOnExit: true, 
...
function PartTransition(_a) {
    ...
    return (React.createElement(CSSTransition, { in: isPresent, addEndListener: function () { }, appear: true }, React.cloneElement(child, { ref: composeRefs(child.ref, ref) })));
}
/**
...
function createFocusTrap(initialConfig) {
    ...
    function startLockingScroll() {
        disableBodyScroll(config.container, { reserveScrollBarGap: true });
    }
    function stopLockingScroll() {
        enableBodyScroll(config.container);
    }
...
var MenuItemImpl = React.memo(React.forwardRef(function MenuItemImpl(_a, forwardedRef) {
    ...
    return (React.createElement(MenuItemPart, __assign({}, props, { ref: forwardedRef, isHighlighted: isHighlighted, isDisabled: isDisabled, isGrouped: isGrouped, 
        ...
        isSelected && (React.createElement(MenuItemIconPart, { menuItemIconStyles: iconStyles },
            React.createElement(CheckIcon, { size: "15", style: { display: 'block' } }))),
...
export { AccessibleIcon, Alert, Arrow, AspectRatio, Avatar, Badge, Blockquote, Box, Button, Card, CardLink, Checkbox, Code, Container, DebugContextProvider, Dialog, Divider, DropdownMenu, Flex, Grid, Header, Image$1 as Image, Input$1 as Input, Link, Lock, Menu, MenuItem, MenuItemCheckbox, MenuItemLabel, MenuItemRadio, MenuItemRadioGroup, MenuItemSeparator, Option$1 as Option, OptionGroup$1 as OptionGroup, Overlay, Pipe, Popover, Portal, Radio, RightClickMenu, RightClickable, Select, SelectWithCustomMenu, SelectWithNativeMenu, Sheet, Slider, InnerTrackPart as SliderInnerTrack, InputPart$1 as SliderInput, TrackPart as SliderTrack, Switch, SwitchContained, SwitchSlider, Tab, TabList, TabPanel, Table, Tabs, Tbody, Td, Text, Textarea, Tfoot, Th, Thead, ToggleButton, Tooltip, Tr, VisuallyHidden, useDropdownMenu };
